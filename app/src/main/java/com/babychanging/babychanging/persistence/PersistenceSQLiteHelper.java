...
public class PersistenceSQLiteHelper extends SQLiteOpenHelper {
    ...
    String sqlCreate_MYFAVORUITES = "CREATE TABLE TABLE_FAV (id TEXT PRIMARY KEY, nameplace TEXT, latitude TEXT, longitude TEXT, urlpic TEXT, province TEXT, state TEXT, address TEXT); ";
